...
if __name__ == '__main__':  
    ...
    # uf.plot_power_load(results, file_names,load_name='L5240-1')
    uf.plot_voltage(results, file_names, complex(5240,0))
    ...
    uf.plot_gen_power(results, file_names, 'G5240-2')
    uf.plot_gen_power(results, file_names, 'G5240-3')
    ...
    uf.plot_line_p(results, file_names, 'L5120-5240')
